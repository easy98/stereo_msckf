...
class MSCKF(object):
    ...
    def feature_callback(self, feature_msg):
        ...
        if not self.is_uwb_init:
            ...
            self.uwb_window.imu_cov.append(self.state_server.state_cov)
            ...
            if len(self.uwb_msg_buffer) >= self.uwb_window.window_size:
                self.initialize_uwb(feature_msg.timestamp)
    ...
    def initialize_uwb(self, time_bound):
        ...
        uwb_init_guess = np.array([[-5.2, -5.0, 0.1],
                                   [5.0, -4.2, 0.1], [-5.2, 10.0, 2.6], [5.0, 10.2 ,2.7]])
        uwb_init = []
        ...
        self.state_server.uwb_state.uwb_positions = uwb_init
        ...
        self.state_server.uwb_state.uwb_positions = self.uwb_gt * 1.04
